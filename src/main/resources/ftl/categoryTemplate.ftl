...
<body>
    ...
    <div class="center">
    	<!--left start-->
        <div class="left">
    <div class="left-top">${(category.column.parentColumn.enName)!'--'}</div>
    <#if ((category.column.parentColumn.childColumn)?size)&gt;0>
    	<ul class="left-menu">
    		<#list category.column.parentColumn.childColumn as childColumn>
               <li>
               		...
               		<ul>
               			<#list childColumn.categorys as cate>
				        	<li><a href='${ctx}/views/html/col/${(cate.enName)?replace('\\s*','','ri')}.htm' title='${cate.enName}' id= >${cate.enName}</a></li>
               			</#list>
		        	</ul>
               		</#if>
               </li>
    ...
    <a href="${ctx}/${(category.column.parentColumn.url)!''}">${category.column.parentColumn.enName}</a>&gt;&gt;
    <a href='${ctx}/${(category.column.url)!''}'>${category.column.enName}</a></div>
</div>
            <div class="con-panel">
            <#--virtual 相对路径-->
