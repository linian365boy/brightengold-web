...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 <%@include file="/views/manage/commons/listJsCss.jsp" %>
 <%@include file="/views/manage/commons/jsCss.jsp" %>
...
<body>
	<jsp:include page="/views/manage/commons/header.jsp"/>
	<jsp:include page="/views/manage/commons/left.jsp">
		<jsp:param value="3" name="menuId"/>
		<jsp:param value="角色管理" name="menuName"/>
	</jsp:include>
	<section id="main" class="column">
	<jsp:include page="/views/manage/commons/message.jsp"/>
		<article class="module width_full">
		<header>
		<h3 class="tabs_involved">角色列表</h3>
		<ul class="tabs">
			<c:url value="${ctx }admin/sys/role/export" var="exportUrl" scope="page"/>
			...
			<tfoot>
                ...
                <td colspan="12">
                	<div class="pagination">
                		<c:import url="/views/manage/commons/page.jsp">
