...
<body>
		...
		action="${ctx}admin/sys/role/add.html" method="post" target="_parent">
			<div class="form-group">
				...
				<div class="col-sm-8">
				     <input type="text" class="form-control" id="describes" name="describes" placeholder="角色"></input>
				</div>
			</div>
			<div class="form-group">
		    	<label for="priority" class="col-sm-3 control-label">排序号<code>*</code></label>
				<div class="col-sm-8">
				     <input type="text" class="form-control" id="priority" name="priority" placeholder="排序号越大，排名越前"></input>
				</div>
			</div>
