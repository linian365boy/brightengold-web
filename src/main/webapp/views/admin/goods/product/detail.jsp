...
<div class="span2">
<c:if test="${!empty relateProducts }">
<h4>Other Available Items In This Category</h4>
<ul class="thumbnails">
	<c:forEach items="${relateProducts }" var="relate" varStatus="relate_index">
		<c:if test="${relate.id != model.id  && relate_index < 6 }"  >
	...
	<footer id="iqFoot" class="container">
		<div class="container-fluid">
			...
			<div class="row-fluid" style="font-size:.8em">
				<div>&copy;&nbsp;2015&nbsp;Copyright. All Rights Reserved.</div>
				<div>
<p>sunshinecigÂ® trade mark and associated market identifiers are the exclusive property of ${company.name}</p>
</div>
			</div>
		</div>
	</footer>
